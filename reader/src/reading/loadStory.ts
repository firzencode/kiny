...
export type LoadOutcome =
  | { ok: true; story: Story; resolveAsset: ResolveAsset; title: string; program: ValidatedProgram; projectCss: string }
...
export async function loadStory(dir: string, seed?: number): Promise<LoadOutcome> {
  ...
  return { ok: true, story: res.story, resolveAsset, title: res.title, program: res.program, projectCss }
}

 ...
 *
 * 用法：
 *   node scripts/build-release.mjs                  # editor + reader，全部 bundle
 *   node scripts/build-release.mjs editor           # 只编 editor
 *   node scripts/build-release.mjs reader --bundles nsis   # 只 reader、只打 nsis
 */
